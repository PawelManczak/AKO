...
mov dx, cs:licznik_pomijania
inc dx
cmp dx, 1
jne nie_wyswietlaj
mov dx, 0
mov cs:licznik_pomijania, dx
...
mov byte PTR es:[bx+1], 00010110B ; kolor - 1|tlo|1|znak
...
;mov bx, 0
mov bx, cs:kolumna
add bx, 2 ; bo 1 znak, drugi kolor
mov cs:kolumna, bx
